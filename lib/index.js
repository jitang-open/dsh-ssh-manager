...
/** @returns the inventory written when no store file exists yet. */
function seedHosts() {
  return [
    {
      id: 'tencent-cloud',
      ...
      port: 22,
      user: 'ubuntu',
      keyPath: '/Users/mac/Documents/key/macbookneo.pem',
      kind: 'linux',
      note: '聚合服务器 · simmer dashboard (https://119.45.179.55/simmer-dashboard/)',
      tags: ['腾讯云', '公网', 'Linux'],
      extraOptions: [],
      createdAt: nowIso(),
      updatedAt: nowIso()
    },
    {
      ...
      port: 22,
      user: '鸡汤',
      keyPath: '/Users/mac/.ssh/id_ed25519',
      kind: 'windows',
      note: 'EasyTier 虚拟网主机 ChickenSoup-BIGWAIFU（Mac 为 10.144.144.3）',
      tags: ['Windows', 'EasyTier', '局域网'],
      extraOptions: [],
      createdAt: nowIso(),
      updatedAt: nowIso()
    }
